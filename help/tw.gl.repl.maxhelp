...
, 							{
								"box" : 								{
									...
									"text" : "Ignore incoming keypresses in the repl.\nDoes the same as the harcoded Option+D/Ctrl+D binding but in option form"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 49.0, 607.0, 150.0, 23.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 27.0, 518.0, 150.0, 23.0 ],
									"text" : "maxpatch gist on github",
									"textjustification" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 629.0, 485.0, 35.0 ],
									"text" : ";\rmax launchbrowser https://gist.github.com/twhiston/1224d30f2a3bbf67d5c67dc80e3f9e74"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 342.0, 157.0, 33.0 ],
									"text" : "copy the line with Option+c / Ctrl + c"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "w erase_color 0 0 0 0.7\r"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Default Short Keys: (mac/windows)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 235.0, 411.5, 174.0, 100.0 ],
									"text" : "type some text and \npresss OPTION + ENTER (osx) CTRL + ENTER (windows) to execute the \"code\". Note that we don't need to go from a symbol or [iter] here"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 290.0, 495.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "3",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "A repl for max in gl, with lots of customizable functionality which you can use to do some exciting things.\nThis is a simple example which you can use to understand some basic functionality. For further examples please see the GLRepl Overview in the Extras menu",
									"textcolor" : [ 0.32548999786377, 0.345097988843918, 0.372548997402191, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 222.0, 517.0, 66.0, 22.0 ],
									"text" : "s codeText"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 439.0, 435.0, 134.0, 114.0 ],
									"text" : "If you use the copy bindings: Option+x/Ctrl+x Option+c/Ctrl+c \nit will also output the copied text from output 2. See the clipboard tab for more about this"
								}
